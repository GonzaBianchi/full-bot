...
export function SearchableSelect({ 
  ...
  return (
    <div ref={containerRef} className={`relative ${isOpen ? 'z-[99999]' : 'z-10'}`}>
      <div
      ...
      {isOpen && (
        <div className="absolute z-[99999] w-full mt-2 bg-gray-800 border-2 border-indigo-500 rounded-lg shadow-2xl overflow-hidden max-h-[300px]">
          <div className="p-2 border-b border-gray-700 bg-gray-800 sticky top-0 z-[99999]">
